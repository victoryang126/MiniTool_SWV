...
from CB_Spec_Tool2 import ConvertSpect2CBSpec as CB_Tool
from CB_Spec_Tool2.Ui_CB_Spec_Tool import Ui_CB_Spec_Tool
from CB_Spec_Tool2.UploadSpec2CodeBeamer import *
