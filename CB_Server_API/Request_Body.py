...
class Post_TestCase_Body:
    ...
    def __init__(self,name):
        ...
        self.customFields = [  #Field_Values(1027,"Incident ID",[],Field_Type.ChoiceFieldValue).__dict__, # Incident Id
                             Field_Values(1035, "Test Method", [], Field_Type.ChoiceFieldValue).__dict__,  # Test Method
...
class TestRunMoel:
    ...
    def __init__(self,name,tracker,test_information):
        ...
        self.customFields = [
            ...
            Field(10003, "Test Information",test_information , Field_Type.TextFieldValue).__dict__, # Test Information
