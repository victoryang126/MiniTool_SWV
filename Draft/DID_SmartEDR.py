...
def GetDIDObjectFromSSDS(ExcelDir,SheetName,OutPut):
    ...
    df = df[["Identifier","Label","ParameterName","DataLength","Offset","BitLength","Scaling","CompareValue","Unit"]]
...
if __name__ == '__main__':
    ...
    DID_Dict_Path = "C:\Python\GitHub\Minitool\DataSource\DIDObject.ts"
